...
//#define POLL_MSG_POLL_SELF_LOCATION_X 20 //broadcasts its own location
//#define POLL_MSG_POLL_SELF_LOCATION_Y 24 //broadcasts its own location
...
#define FINAL_MSG_NEXT_INIT_IDX 11
#define FINAL_MSG_IMU_DATA_IDX 48


#define RESP_MSG_PRIORITY_IDX 11
#define RESP_MSG_PREV_DB_IDX 12
#define RESP_MSG_PREV_RB_IDX 18
#define RESP_MSG_SELF_LOCATION_X 28 //broadcasts its own location
#define RESP_MSG_SELF_LOCATION_Y 32 //broadcasts its own location

//CIR
#define RESP_MSG_POLL_PW_IDX 24

#define POLL_MSG_RAND_BOUND_IDX 12

#define ANY_MSG_TS_LEN 5
#define ANC_LOCATION_LENTH 4

//#define FIXED_DELAY 3
int32_t FIXED_DELAY = 3;
